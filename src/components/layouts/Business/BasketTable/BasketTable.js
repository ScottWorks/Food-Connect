  ...
  render() {
    ...
    return (
      <div className="BasketTable">
        ...
        <div>
          <p>
            {this.props.editingBasket
              ? fromEpoch(this.props.pick_up_time, 'ddd, MMM Do, h:mm a')
              : ''}
          </p>
        </div>
...
export default connect(
  mapStateToProps,
  { addItemToBasket, makeBasket, saveBasket }
)(BasketTable);