        ...
        <div className="landing_wrapper">
          ...
          >
            <div className="FAQ_contents">
              ...
              <h4>What do we do?</h4>
              <p>
                We uhhh take your expiring food, and give it to someone in need!
              </p>
              <h4>What is in it for me?</h4>
              <p>
                You get to help those in need, and receive a nifty tax refund.
              </p>
          ...
          <section className="landing_hexmap">
            ...
            <div className="landing_hexmap_container">
              <h3 />
            </div>
          </section>
          <hr />
          <section className="landing_about">
            ...
            <div className="landing_about_container">
              <p>
                Lorem ipsum dolor amet ethical bushwick etsy street art hammock
                fixie cloud bread la croix prism flexitarian man braid meh
                cliche.
              </p>
              <p>
                Actually skateboard chillwave edison bulb literally, live-edge
                chambray wayfarers craft beer poke pitchfork lo-fi vice
                flexitarian put a bird on it. Distillery godard PBR palo santo
                everyday carry live-edge lyft you probably haven't heard of
                them, kinfolk tumblr freegan raw denim pickled.
              </p>
              <p>
                Fashion axe skateboard prism jean shorts iceland woke 8-bit
                tumblr hoodie franzen pork belly austin.
              </p>
              <p>Oh. You need a little dummy text for your mockup?</p>
              <p> How quaint.</p>
            </div>
          </section>
          <hr />
              ...
              <div className="landing_stats_column">
                <p className="landing_stats_p">
                  {utilFunc.formatNumber(
                    Number(this.props.landingTotalSavedByWeight, 0, 3, ',', '.')
                  )}
                </p>
                <h3>
