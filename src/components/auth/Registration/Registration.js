...
class Register extends Component {
  constructor() {
    ...
    this.getAddressFromAutoComplete = this.getAddressFromAutoComplete.bind(
      this
    );
  ...
  handleContinueClickPanel1(e) {
    ...
    if (this.state.organizationType === '') {
      ...
      this.setState({
        panel1State: tempPanel1State,
        panel2State: tempPanel2State
      });
    }
  }
  ...
  handlePanelHeader2Click() {
    if (
      this.state.panel2State.panel2BodyState === 'panel-body-collapsed' &&
  ...
  handlePanelHeader3Click() {
    if (
      this.state.panel3State.panel3BodyState === 'panel-body-collapsed' &&
      this.state.organizationName !== '' &&
      this.state.organizationType !== '' &&
      this.state.specificType !== ''
    ) {
  ...
  handlePanelHeader4Click() {
    if (
      this.state.panel4State.panel4BodyState === 'panel-body-collapsed' &&
      this.state.organizationName !== '' &&
      this.state.organizationType !== '' &&
      this.state.fein !== '' &&
      this.state.specificType !== '' &&
      ...
      <div className="registration_main">
        ...
        <div className="registration_wrapper">
          <section className="question-panel">
            <div
              onClick={() => this.handlePanelHeader1Click()}
            ...
            <div className={this.state.panel1State.panel1BodyState}>
              ...
              <form className="registration-form">
                ...
                <input
                  ...
                  type="submit"
                  onClick={(e) => this.handleContinueClickPanel1(e)}
                  value="Continue"
                />
              </form>
            </div>
          ...
          <section className="question-panel">
            <div
              className={this.state.panel2State.panel2HeaderState}
            ...
            <div className={this.state.panel2State.panel2BodyState}>
              ...
              <form className="registration-form">
                ...
                <input
                  ...
                  required="true"
                  placeholder={`Enter Type of ${this.state.organizationType}`}
                  type="text"
                />
                ...
                <input
                  ...
                  type="submit"
                  value="Continue"
                  onClick={(e) => this.handleContinueClickPanel2(e)}
                />
              </form>
            </div>
          </section>
          ...
          <section className="question-panel">
            <div
              className={this.state.panel3State.panel3HeaderState}
              onClick={() => this.handlePanelHeader3Click()}
            >
              Location
            </div>
            <div className={this.state.panel3State.panel3BodyState}>
              ...
              <form className="registration-form">
                ...
                <input
                  id="button3"
                  className="form-continue-button"
                  onClick={(e) => this.handleContinueClickPanel3(e)}
                  type="submit"
                  value="Continue"
                />
              </form>
          ...
          <section className="question-panel">
            <div
              className={this.state.panel4State.panel4HeaderState}
            ...
            <div className={this.state.panel4State.panel4BodyState}>
              ...
              <form className="registration-form">
                ...
                <input
                  id="input7"
                  onChange={(e) =>
                    this.setState({ operating_hours: e.target.value })
                  }
                ...
                <div className="password_div">
                  ...
                  />
                  {!this.state.pwShowHide1 ? (
                    <img
                      src={hidePassword}
                      onClick={() => this.seePassword(1)}
                ...
                <div className="password_div">
                  ...
                  />
                  {!this.state.pwShowHide2 ? (
                    <img
                      src={hidePassword}
                      onClick={() => this.seePassword(2)}
                      className="password_icon"
                    />
                  ) : (
                    <img
                ...
                <input
                  id="button4"
                  onClick={(e) => this.registerOrganization(e)}
                  className="form-continue-button"
                  type="submit"
                  value="Register"
                />
